        ...
        <div className="flex flex-col justify-center items-center mt-5">
          ...
          <div>
            <h1 className={`${style.heroHeadText} text-white`}>
              Hello, I'm <span className="text-[#915eff]">DAVID RAJU K S</span>
            </h1>
            <p className={`${style.heroSubText} mt-2 text-white-100`}>
              I am a <span className="text-[#915eff]">Chief Operating Officer</span> at
              <span className="text-[#915eff]"> GoldenZ Vision</span>
            </p>
          </div>
        </div>
      </div>
